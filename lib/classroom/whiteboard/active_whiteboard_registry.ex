defmodule Classroom.ActiveWhiteboard.Registry do
  use GenServer

  #API

  def start_link(_args) do
    GenServer.start_link(__MODULE__, nil, name: :whiteboard_registry)
  end

  def whereis_name(class_name) do
    GenServer.call(:whiteboard_registry, {:whereis_name, class_name})
  end

  def register_name(class_name, pid) do
    GenServer.call(:whiteboard_registry, {:register_name, class_name, pid})
  end
